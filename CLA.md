...
- the **AGPL-3.0-or-later** (the project's open-source license), and
...
(see [`LICENSING.md`](LICENSING.md)) while still releasing it as AGPL. Your
contribution itself also remains available under the AGPL, like the rest of
the project.
